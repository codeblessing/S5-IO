...
import pl.poznan.put.jsontools.logic.JsonTransformRemoveAttributes;
...
//        JsonValidator.validateAll(request.data);
//        JsonValidator.validateAll(request.transforms);
...
//        JsonValidator.validate(request.data.toString());
